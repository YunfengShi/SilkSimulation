...
<Repository Contents>
s2_ani: LAMMPS input script for building and preparing the initial silk configuration for a small system.
...
2. Preparation of multi-chain system: Replicates the system to create 64 chains.
