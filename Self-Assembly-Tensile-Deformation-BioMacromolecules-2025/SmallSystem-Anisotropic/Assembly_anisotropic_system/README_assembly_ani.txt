This repository contains files and scripts for simulating the assembly of an anisotropic (H8S24)16 silk system using LAMMPS.
...
<Repository Contents>
s_hydro2_ani: LAMMPS input script to simulate the system assembly for a small testing system.
...
1. Read data: Loads after.data, generated from a previous initialsetup simulation.
2. Hydrostatic Compression: Applies low pressure (P = 0.001 reduced unit) 
3. High-Pressure Compression: Further compresses the system at high pressure (P = 1 reduced unit).
4. Decompression
5. Relaxation
